...
Module: Model4925_cMeasurementLoop.cpp
...
void cMeasurementLoop::updateSynchronousMeasurements()
    ...
    */
    ...
    if (fCompostTemp)
        ...
        float compostTemp = sensor_CompostTemp.getTempCByIndex(0);
        this->m_data.compost.TempC = compostTemp;
        this->m_data.flags |= Flags::TempC;
        }
